/*======================= CONSTRAINTS - KISITLAMALAR ======================================
 ...
 CREATE TABLE calisanlar
    ...
    INSERT INTO calisanlar VALUES('10006', 'Canan Yaş', NULL, '2019-04-12'); -- maaş null olmamalı
    INSERT INTO calisanlar VALUES('10003', 'CAN', 5000, '2018-04-14');
    INSERT INTO calisanlar VALUES('10007', 'CAN', 5000, '2018-04-14'); -- iki kere aynı isim olmamalı
    INSERT INTO calisanlar VALUES('10009', 'cem', '', '2018-04-14');-- maaş int olmalı 
    INSERT INTO calisanlar VALUES('', 'Osman', '2000', '2018-04-14');-- '' bunu (hiçlik) kabul eder
    INSERT INTO calisanlar VALUES( '10002', 'Ayşe Yılmaz' ,12000, '2018-04-14'); -- id tekrarlı olamaz (primary key)
    INSERT INTO calisanlar VALUES( null, 'Ahmet' ,12000, '2018-04-14'); -- primary key olduğundan null yazılmaz
