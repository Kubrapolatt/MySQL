...
==============================================================================*/  
   ...
   CREATE TABLE tedarikciler -- parent tablo
    (
        vergi_no int PRIMARY KEY,  -- parent old. için primary key var
    ...
    CREATE TABLE urunler  -- child tablo
    (
        ted_vergino int, 
        urun_id int, 
...
/*-----------------------------------------------------------------------------
 ...
 -- tedarikcilerin insert'lerini tekrar yapıyoruz
